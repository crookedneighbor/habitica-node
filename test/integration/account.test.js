...
describe('Account', () => {
  describe('#register', () => {
    ...
    context('Successful', () => {
      ...
      it('returns a new user', async function () {
    ...
    context('Uuid or token already set', () => {
      it('throws an error if uuid is already set', async function () {
      ...
      it('throws an error if token is already set', async function () {
      ...
      it('allows the creation of a new user when uuid or token is already set if resetOldCreds option is passed in', async function () {
